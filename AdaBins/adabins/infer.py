...
from adabins import model_io, utils
...
class InferenceHelper:
    def __init__(self, path, dataset="nyu", device="cuda:0"):
        ...
        if dataset == "nyu":
            ...
            pretrained_path = os.path.join(path, "AdaBins_nyu.pt")
        elif dataset == "kitti":
            self.min_depth = 1e-3
            self.max_depth = 80
            ...
            pretrained_path = os.path.join(path, "AdaBins_kitti.pt")
        else:
            raise ValueError(
